...
export function transformInfringement(dbInfringement: Infringement, brandName: string = 'Unknown'): InfringementItem {
  return {
    ...
    listingPrice: dbInfringement.primary_listing_price_value ?? undefined,
    listingCurrency: dbInfringement.primary_listing_currency || undefined,
    listingPriceText: (dbInfringement.evidence_snapshot as Record<string, unknown> | null)?.priceText as string | undefined,
    listingRating: dbInfringement.primary_rating ?? undefined,
    listingReviewsCount: dbInfringement.primary_reviews_count ?? undefined,
    listingInStock: dbInfringement.primary_in_stock ?? undefined,
    listingCondition: dbInfringement.primary_condition || undefined,
    listingPosition: dbInfringement.primary_listing_position ?? undefined,
    revenueAtRiskUsd: dbInfringement.revenue_at_risk_usd ?? undefined,
    revenueConfidence: dbInfringement.revenue_confidence ?? undefined,
    evidenceSnapshot: dbInfringement.evidence_snapshot as Record<string, unknown> | undefined,
    whois: {
